<template>
  <div>
    <v-container>
      <v-toolbar flat>
        <v-spacer>
          <v-toolbar-title><center>Listagem de Faltas</center></v-toolbar-title>
        </v-spacer>
      </v-toolbar>
    </v-container>
